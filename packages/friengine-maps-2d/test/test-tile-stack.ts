import { TileStack, Map2dShape } from "friengine-maps-2d";
...
describe("TileStack", () => {
    ...
    it("has correct list of objects", () =>
        expect(tileStack.allObjects).toEqual([
            { shape: Map2dShape.POINT,  id: 1, name: "Object 1", type: "type-1", position: vec2(4, 4) },
            { shape: Map2dShape.POINT,  id: 3, name: "Object 3", type: "type-3", position: vec2(4, 4) },
            { shape: Map2dShape.POINT,  id: 4, name: "Object 4", type: "type-4", position: vec2(4, 4) },
        ]));
});
